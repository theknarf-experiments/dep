...
pub const JS_EXTENSIONS: &[&str] = &["js", "jsx", "ts", "tsx", "mjs", "cjs", "mts", "cts"];
...
pub fn resolve_relative_import(dir: &VfsPath, spec: &str) -> Option<VfsPath> {
...
pub fn resolve_alias_import(aliases: &[(String, VfsPath)], spec: &str) -> Option<VfsPath> {
